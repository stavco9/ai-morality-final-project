...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    describeClaimSummary: "Enter the claim summary...",
  ...
  he: {
    ...
    claimSummary: "סיכום התביעה",
    documentEvidence: "ראיות מסמכים",
    plaintiffDocuments: "מסמכי התובע",
    defendantDocuments: "מסמכי הנתבע",
    plaintiffLetter: "העלה כתב תביעה בפורמט PDF",
    defendantLetter: "העלה כתב הגנה בפורמט PDF",
    plaintiffEvidence: "העלה מסמכים וראיות התומכים בתביעה",
    defendantEvidence: "העלה מסמכים וראיות התומכים בהגנה (אופציונלי)",
    ...
    describeClaimSummary: "הזן את סיכום התביעה..",
    required: "שדה חובה",
